...
func TestStartupSummaryRendersRuntimeMetadataWithoutSecret(t *testing.T) {
	...
	output := StartupSummary(cfg, "3.0.0")

	for _, want := range []string{"rw-node-go starting", "Project Version", "Panel Node Version", "3.0.0", "embedded xray-core", "0.0.0.0:2222", "127.0.0.1:61001", "TLS Enabled", "TLS Client Auth", "mtls", "JWT Enabled"} {
